export default function Lab1() {
    return (
        <div id="wd-lab1">
            <h1>Lab 1 | Misha Tabatabai | CS4550</h1>
            <h2>HTML Examples</h2>
            <div id="wd-h-tag">
                <h3>Heading Tags</h3>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <a href="https://github.com/misha-tabatabai/kambaz-react-web-app-cs4550-sp25/tree/a1" id="wd-github"> Misha Tabatabai Github </a><br />
                </form>
            </div>
        </div>
    );
